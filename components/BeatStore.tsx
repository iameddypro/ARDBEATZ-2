...
const PACKS: BeatPack[] = [
  {
    ...
    fileUrl: 'https://cdn.pixabay.com/audio/2022/03/24/audio_0656a2977d.mp3' // Placeholder
  },
  {
    id: 'p2',
    ...
    fileUrl: 'https://cdn.pixabay.com/audio/2022/05/27/audio_1808fbf07a.mp3' // Placeholder
  }
];
        ...
        <div className="bg-black/30 p-1 rounded-xl flex gap-1 border border-white/5">
          <button 
            ...
            className={`px-6 py-2.5 rounded-lg text-sm font-medium transition-all ${
              activeTab === 'beats' 
                ? 'bg-ard-primary text-white shadow-lg' 
      ...
      <div className="bg-ard-card/50 rounded-3xl border border-white/5 overflow-hidden backdrop-blur-sm min-h-[400px]">
        ...
        {activeTab === 'beats' ? (
          ...
          <div className="p-8 grid grid-cols-1 md:grid-cols-2 gap-8">
            {PACKS.map((pack) => (
              <div key={pack.id} className="bg-black/20 border border-white/10 rounded-2xl overflow-hidden hover:border-ard-primary/50 hover:shadow-2xl hover:shadow-ard-primary/10 transition-all duration-300 flex flex-col">
                <div className="relative h-48 overflow-hidden group">
                  ...
                  <div className="absolute inset-0 bg-gradient-to-t from-black/80 to-transparent flex items-end p-6">
                    <div className="w-full">
                       <h3 className="text-2xl font-bold text-white mb-1">{pack.title}</h3>
                ...
                <div className="p-6 flex-1 flex flex-col">
                    ...
                    <ul className="space-y-2">
                      {pack.beatsIncluded.map((beatName, idx) => (
                        <li key={idx} className="flex items-center text-sm text-gray-300">
                          <CheckCircle2 className="w-4 h-4 text-ard-secondary mr-2" />
                          {beatName}
                        </li>
                      ))}
                    </ul>
                  ...
                  <div className="flex items-center justify-between pt-6 border-t border-white/5">
                    ...
                    <Button onClick={() => openBuyModal(pack)}>
                      Buy Pack
